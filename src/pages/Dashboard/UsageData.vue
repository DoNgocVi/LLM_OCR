  ...
  <div ref="containerChartRef" class="bg-white mt-5 rounded-[20px] pos-relative overflow-hidden">
    <div class="flex justify-between px-6 pt-6 pb-4 gap-4">
      ...
      <div class="flex flex-wrap justify-end items-center gap-3 flex-1">
        <div class="flex items-center gap-1 text-sx text-gray_light start">
    ...
    >
      <div
        class="w-[28px] h-[28px] border-1 border-[#D1D1D1] border-solid rounded-[4px] flex justify-center items-center pointer-events-auto hover:bg-gray-3 transition-all"
        @click="scrollLeft"
      >
...
<script setup lang="ts">
  ...
  const option = ref<EChartsOption>({
    ...
    dataZoom: [
      ...
      {
        type: 'inside', // Kích hoạt cuộn trong biểu đồ
        xAxisIndex: 0,
        minSpan: 20,
        start: 0,
        end: 100,
...
<style scoped lang="scss">
  ...
  .chart-vue .echarts-slider {
    border-radius: 10px; /* Bo tròn thanh chính */
  }

  .chart-vue .echarts-slider-handle {
    border-radius: 50%; /* Bo tròn tay cầm */
    background: #5b5b5b !important; /* Màu nền tay cầm */
    border: 2px solid #ccc; /* Màu viền tay cầm */
  }
</style>
